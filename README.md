...
**https://vidyutra.com**  
(or via the custom domain configured using `CNAME`)

---

## Overview

Vidyutra is a technology initiative with a focused and minimal online presence, built to support innovation across electronics, communication systems, and digital platforms.
